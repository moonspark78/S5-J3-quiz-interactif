...
import {
	...
	lockAnswers,
	markCorrectAnswer,
	createSummaryTable, // Importez la nouvelle fonction
} from "./dom.js";
...
const uiText = {
	fr: {
		...
		summaryTableTitle: "Récapitulatif des réponses", // Nouveau texte
		summaryQuestion: "Question", // Nouveau texte
		summaryYourAnswer: "Votre réponse", // Nouveau texte
		summaryCorrectAnswer: "Bonne réponse", // Nouveau texte
	},
	en: {
		title: "Dynamic Quiz",
		...
		summaryTableTitle: "Answer Summary", // New text
		summaryQuestion: "Question", // New text
		summaryYourAnswer: "Your Answer", // New text
		summaryCorrectAnswer: "Correct Answer", // New text
	},
};
...
let timerId = null;
let answeredQuestionsSummary = []; // Nouvelle variable pour le récapitulatif
...
const summaryTableContainer = getElement("#summary-table-container"); // Nouveau conteneur
...
function startQuiz() {
	...
	score = 0;
	answeredQuestionsSummary = []; // Réinitialise le récapitulatif
...
function showQuestion() {
	...
	timerId = startTimer(
		...
		() => {
			// Si le temps est écoulé, considérer comme une mauvaise réponse
			const q = questions[currentQuestionIndex];
			answeredQuestionsSummary.push({
				question: q.text,
				yourAnswer: uiText[languageSelect.value].timeLeft + " : 0s", // Ou une autre indication pour "pas de réponse"
				correctAnswer: q.answers[q.correct],
				isCorrect: false,
			});
			lockAnswers(answersDiv);
			markCorrectAnswer(answersDiv, q.correct); // Afficher la bonne réponse même si le temps est écoulé
...
function endQuiz() {
	...
	// Générer et afficher le tableau récapitulatif
	...
	// Assurez-vous que le conteneur est vide avant d'ajouter le nouveau tableau
...
function restartQuiz() {
	...
	bestScoreIntroLabel.textContent = bestScoreLabel + " : ";
	summaryTableContainer.innerHTML = ""; // Vide le tableau récapitulatif
}
